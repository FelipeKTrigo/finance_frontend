  ...
  Widget build(BuildContext context) {
    return CustomScrollView(slivers: <Widget>[
      CupertinoSliverNavigationBar(
        largeTitle: Container(alignment: Alignment.center,child: const Text('APRENDER')),
      ),
      SliverSafeArea(
        top: false,
